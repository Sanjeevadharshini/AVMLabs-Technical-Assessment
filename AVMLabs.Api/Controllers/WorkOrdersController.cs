...
namespace AVMLabs.Api.Controllers
{
    ...
    public class WorkOrdersController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ApiResponse<List<WorkOrderResponseDto>>>> GetWorkOrders()
        {
            var workOrders = await _workOrderService.GetWorkOrdersAsync();

            return Ok(ApiResponse<List<WorkOrderResponseDto>>.SuccessResponse(workOrders, "Work orders retrieved successfully."));
        }
    }
}