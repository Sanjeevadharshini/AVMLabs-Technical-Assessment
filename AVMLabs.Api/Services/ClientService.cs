...
namespace AVMLabs.Api.Services
{
    public class ClientService : IClientService
    {
        ...
        public async Task<ClientResponseDto> UpdateClientAsync(int clientId, UpdateClientDto dto)
        {
            ...
            var duplicateEmail = await _context.Clients.AnyAsync(x => x.ClientId != clientId && x.Email == dto.Email);
            ...
            var outstanding = await _calculator.GetForClientAsync(clientId);
